...
|                                                                                                                                                                                                          1. `List`s in Pythonn <br> 1.`List index` to get an element <br> 1.`.append()` to add element to a list <br>   1. `while`, `continue`, `break` for iterations over a list  <br> 1. (Im)Mutable types                                                                                                                                                                                                          | 17.09.2022 |               [Lec#3]()               |             HW # 0 (due to 16.10)              |  |
