...
|                                                                                                                                                                                                         1. RegExp in `Python`  <br>  1. `search` and `findall` in regexp  <br>  1. reg exp `pattern` - how it works  <br> 1. `match` and `group` - difference  <br> 1. splitting and substitution with re <br>                                                                                                                                                                                                         | 15.10.2022 |                      [Lec#6](https://youtu.be/uy_x5jS_Bzs)                       | Only home task in week 6 for additional points |  |
