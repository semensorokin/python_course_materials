...
|                                                                                                                                                                                                                     1. Functions in `Python`  <br>  1. `*args` and `**kwargs` in functions  <br>  1. `lambda` functions  <br> 1. `map` with functions  <br> 1. intro to recursion in python  <br>                                                                                                                                                                                                                      | 15.10.2022 |                      [Lec#6]()                       | Only home task in week 6 for additional points |  |
